...
const SliderArrL = styled.svg`
  width: 100px;
  stroke: rgba(255, 255, 255, 0.5);
`;

const SliderArrR = styled.svg`
  width: 100px;
  stroke: rgba(255, 255, 255, 0.5);
`;
...
function Slider() {
  ...
  return (
    <Wrapper>
      <SliderArrBox>
        <SliderArrL viewBox="0 0 24 24" stroke="rgba(255,255,255,0.5)" onClick={decreaseIndex}>
      ...
      <SliderArrBox>
        <SliderArrR viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" onClick={increaseIndex}>
          <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
          <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
          <g id="SVGRepo_iconCarrier">
            {" "}
